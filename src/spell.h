...
class GeneralLuaSpell : public ConfigurableSpell
{
public:
  virtual CSpellActionBase* cast( CCharacter* creator, CCharacter* target, bool child );
  virtual CSpellActionBase* cast( CCharacter* creator, int x, int y );
...
protected:
  GeneralLuaSpell();
  GeneralLuaSpell( GeneralLuaSpell* other );

private:
  friend CSpellActionBase* SpellCreation::getGeneralLuaSpell();
  friend CSpellActionBase* SpellCreation::getGeneralLuaSpell( GeneralLuaSpell* other );
