...
{
  /* defined here is the different types
   * of trigger we can have for our triggerSpells.
   * Many more could be added later on.
   * Example: BLOCKING, AVOIDING, PARRY, CRITICALHIT, etc...
   */
  enum TriggerType
  {
    TAKING_DAMAGE,
