...
function quest_hexmaster.showNoviceText( part )
	...
	if ( part == 2 ) then
		...
		quest_hexmaster.quest:setDescription( "Lead the novice mages to the locked dungeon door so they can try to spell it open")
	end
end
...
function quest_hexmaster.showMagicDoorText( part )
	...
	then
		...
		quest_hexmaster.quest:setDescription( "Tell Ornad Saidor in Arinox that you have found a locked door and within the piece of a robe.");
	...
	then
		...
		quest_hexmaster.quest:setDescription( "Explore the depth of the Arinox dungeon and find Jorni.");
	end
end
